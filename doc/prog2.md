...
No current can flow throught a *floating* thing..
...
So, if we could route this signal to a RPi input, we could listen to the PIC when it's driving the PGD output. This is exaclty what we have done here.
