...
{
       0,   147,   147,   148,   149,   149,   154,   157,   163,   169,
     175,   181,   187,   210,   221,   233,   246,   251,   256,   261,
     268,   273,   280,   282,   288,   291,   296,   301,   308,   313,
     316,   316,   316,   316
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LKRPATH", "STRING", "ERROR", "NUMBER", "DEFINE", "IFDEF", "ELSE", "FI",
  "'='", "'+'", "'-'", "'/'", "'*'", "'\\n'", "';'", "$accept", "program",
  "$@1", "line", "path_list", "parameter_list", "e1", "e1op", "e0",
  "macroval", "aop", YY_NULLPTR
};
#endif
...
{
       1,    -5,    36,    37,    37,    36,    -5,     6,    13,    -5,
      -5,     3,    -5,    -5,    -5,    -5,    -5,    12,    -5,     4,
       5,    -5,    -5,    -5,    14,    -5,    -5,    -5,    -5,    -5,
      36,    37,    37,    -5,    -5,    31,    26,    -5,    -5,    -5,
      -5,    -5,    -5,    -5,    14,    -5,    -5
};
...
{
       0,     3,     0,     0,     0,     0,    11,     0,     0,    14,
      15,     0,     2,    25,    26,    27,     9,    20,    22,    16,
      18,     7,     8,    10,     0,    13,     1,     4,    24,    21,
       0,     0,     0,    28,    29,     0,     6,    23,    17,    19,
      30,    31,    32,    33,     0,     5,    12
};
...
{
      22,    -6,     1,    26,     2,     3,     4,     5,     6,    24,
       7,     8,     9,    10,    23,    13,    25,    33,    14,    -6,
      15,    27,    34,    31,    32,    28,    29,    38,    39,     2,
       3,     4,     5,     6,    45,     7,     8,     9,    10,    13,
      19,    37,    14,    20,    15,    40,    41,    42,    43,     0,
       0,    46
};
...
{
       4,     0,     1,     0,     3,     4,     5,     6,     7,     3,
       9,    10,    11,    12,     5,     3,     3,     3,     6,    18,
       8,    18,     8,    19,    19,    13,    17,    31,    32,     3,
       4,     5,     6,     7,    36,     9,    10,    11,    12,     3,
       3,    30,     6,     6,     8,    14,    15,    16,    17,    -1,
      -1,    44
};
...
static const yytype_uint8 yystos[] =
{
      ...
      12,    21,    23,     3,     6,     8,    25,    26,    28,     3,
       6,    24,    24,    25,     3,     3,     0,    18,    13,    25,
      27,    19,    19,     3,     8,    29,    22,    28,    24,    24,
      14,    15,    16,    17,    30,    23,    29
};
...
#line 170 "parse.y" /* yacc.c:1646  */
    {
	  if (state.ifdef == NULL || state.ifdef->istrue)
	    execute_command((yyvsp[-1].s), (yyvsp[0].p));
	}
#line 1396 "parse.c" /* yacc.c:1646  */
    break;
...
#line 188 "parse.y" /* yacc.c:1646  */
    {
	  ...
	  if (state.ifdef == NULL || state.ifdef->istrue) {
	    long newval = 0, lh = (yyvsp[-2].l), rh = (yyvsp[0].l);
	    ...
	    add_script_macro((yyvsp[-3].s), newval);
	  }
	}
...
#line 211 "parse.y" /* yacc.c:1646  */
    {
	  ...
	  ifdef->istrue = (((state.ifdef == NULL) || state.ifdef->istrue) &&
			   get_symbol(state.script_symbols, (yyvsp[0].s)));
	  ifdef->inelse = false;
	  ifdef->prev = state.ifdef;
	  state.ifdef = ifdef;
	}
#line 1454 "parse.c" /* yacc.c:1646  */
    break;
...
#line 309 "parse.y" /* yacc.c:1646  */
    {
	  (yyval.l) = get_script_macro((yyvsp[0].s));
	}
